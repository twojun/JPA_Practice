...
2024.02.03 - Dirty checking & merge 부분 내용 추가</br></br></br>

(1) 실무에서는 ManyToMany 관계는 사용하지 않는다.</br>
(2) ManyToOne 단방향으로 많이 설계하고 필요에 따라 양방향으로 가져간다.</br>
(3) OneToMany 연관관계도 많이 사용하지 않는다.</br></br></br></br></br>
